...
<body>
    ...
    <div id="popup-success" class="popup">
        姐姐是小狗心目中最厉害的人~─=≡Σ((( つ•̀ω•́)つ
    </div>

    <audio id="music_bg" src="your_music_file.mp3"></audio>
    <!-- 其他 HTML 内容 -->

    <script src="https://code.jquery.com/jquery-3.6.0.min.js"></script>
    <script src="https://cdnjs.cloudflare.com/ajax/libs/animo.js/0.4.1/animo.min.js"></script>
